...
const StyledAddressButton = styled.div`
  ...
  flex-direction: column;
`;
const NewAddressForm = ({ isOpen, setIsOpen }) => {
  return (
    <div>
      <Modal
        isOpen={isOpen}
        ...
        height={"651px"}
      >
        <StyledEditAddressH1>Добавить новый адрес</StyledEditAddressH1>
        <StyledAddressDiv>
          <StyledAddressLabeleAddres>
            Введите ваш адрес
          </StyledAddressLabeleAddres>
          <Input variant="enteryouraddress" placeholder="Город, улица и дом" />
        </StyledAddressDiv>
        <StyledDivInput>
          <div>
